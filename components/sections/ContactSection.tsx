...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative w-full py-24 bg-slate-50/50 dark:bg-slate-950/40 border-t border-slate-200/80 dark:border-slate-800/80 transition-colors overflow-hidden">
      {/* Ambient Atmospheric Background Glows */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[550px] h-[400px] bg-gradient-to-tr from-rose-500/10 via-indigo-500/10 to-transparent rounded-full blur-3xl pointer-events-none" aria-hidden="true" />
      <div className="absolute -bottom-20 -left-20 w-[400px] h-[400px] bg-gradient-to-br from-cyan-500/10 to-transparent rounded-full blur-3xl pointer-events-none" aria-hidden="true" />
      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10">
        ...
        <Backlight blur={45} className="w-full">
          <div className="w-full bg-white dark:bg-slate-900/95 border border-slate-200/90 dark:border-slate-800 rounded-3xl p-6 sm:p-10 shadow-[0_15px_40px_-10px_rgba(15,23,42,0.08),0_2px_8px_-2px_rgba(15,23,42,0.04)] backdrop-blur-2xl">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3.5 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:bg-white dark:focus:bg-slate-900 transition-all text-slate-950 dark:text-white text-sm shadow-2xs"
                >
